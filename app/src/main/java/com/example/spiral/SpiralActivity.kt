...
class SpiralActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filename = hand + "_Sp_" + badHabits + "_" + currentDate.toString() + ".csv"
    ...
    fun nextSpiral(view: View) {
        val nextIntent = Intent(this, InSpiralActivity::class.java)
    ...
    internal class SpiralView(context: Context?, attrs: AttributeSet) : View(context) {
